    ...
    if (currentPageNumber === 1) {
      ...
      if (devices.length === 0) {
        const message = (
          <div>
            <center>
              <p className="title has-text-danger">Ledger Detect Error!</p>
            </center>
            <br />
            <p className={`subtitle ${textColor}`}>
              No ledger was detected. Make sure you have a ledger plugged in and
              try again.
            </p>
          </div>
        );
            ...
            <div className={`steps ${textColor} is-dark`} id="stepsDemo">
              ...
              >
                ...
                <div className="step-details">
                  <p className="step-title">Enter Scan Height</p>
                </div>
              </div>
              <div
                className={`step-item ${
                ...
                {this.state.waitingOnLedger && (
                  <center>
                    ...
                    <div className="mid-div">
                      <div className={`inner-div box ${fillColor}`}>
                        <div className={`title ${textColor}`}>
                          <ReactLoading
                            ...
                            width={100}
                          />
                          <br /> Please Confirm Prompt on your Ledger
                        </div>
                      </div>
                    </div>{' '}
                  </center>
